...
public abstract class ProcessingJavascriptObject extends JavaScriptObject {
	...
	public final native void ellipse(double x, double y, double width, double height) /*-{
	...
	public final native void quad(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) /*-{
		this.quad(x1, y1, x2, y2, x3, y3, x4, y4);
	}-*/;

	public final native void triangle(int x1, int y1, int x2, int y2, int x3, int y3) /*-{
		this.triangle(x1, y1, x2, y2, x3, y3);
	}-*/;

	public final native void bezier(int x1, int y1, int x2, int y2, int x3,	int y3, int x4, int y4) /*-{
	...
	public final native void bezierPoint(double a, double b, double c, double d, double t) /*-{
		this.bezierPoint(a, b, c, d, t);
	}-*/;
	...
	public final native void bezierTangent(double a, double b, double c, double d, double t) /*-{
		this.bezierTangent(a, b, c, d, t);
	}-*/;

	public final native void curve(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) /*-{
		this.curve(x1, y1, x2, y2, x3, y3, x4, y4);
	}-*/;

	public final native void curve(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4) /*-{
		this.curve(x1, y1, x2, y2, x3, y3, x4, y4);
	}-*/;

	public final native void curve(int x1, int y1, int z1, int x2, int y2, int z2, int x3, int y3, int z3, int x4, int y4, int z4) /*-{
		this.curve(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4);
	}-*/;

	public final native void curve(double x1, double y1, double z1, double x2, double y2, double z2, double x3, double y3, double z3, double x4, double y4, double z4) /*-{
		this.curve(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4);
	}-*/;
	...
	public final native void curvePoint(double a, double b, double c, double d, double t) /*-{
		this.curvePoint(a, b, c, d, t);
	}-*/;

	public final native void curveTangent(double a, double b, double c, double d, double t) /*-{
	...
	public final native void arc(int x, int y, int width, int height, int start, int stop) /*-{
	...
	public final native void bezierVertex(int cx1, int cy1, int cz1, int cx2, int cy2, int cz2, int x, int y, int z) /*-{
		this.bezierVertex(cx1, cy1, cz1, cx2, cy2, cz2, x, y, z);
	}-*/;

	public final native void bezierVertex(double cx1, double cy1, double cx2, double cy2, double x, double y) /*-{
		this.bezierVertex(cx1, cy1, cx2, cy2, x, y);
	}-*/;

	public final native void bezierVertex(double cx1, double cy1, double cz1, double cx2, double cy2, double cz2, double x, double y, double z) /*-{
		this.bezierVertex(cx1, cy1, cz1, cx2, cy2, cz2, x, y, z);
	}-*/;
	...
	public final native void vertex(double x, double y, double x2, double y2, double x3, double y3) /*-{
	...
	public final native void text(String str, int x, int y, int width, int height) /*-{
		this.text(str, x, y, width, height);
	}-*/;

	public final native void text(String str, double x, double y, double width, double height) /*-{
		this.text(str, x, y, width, height);
	}-*/;

	public final native void text(String str, int x, int y, int width, int height, int z) /*-{
		this.text(str, x, y, width, height, z);
	}-*/;

	public final native void text(String str, double x, double y, double width, double height, double z) /*-{
		this.text(str, x, y, width, height, z);
	}-*/;
	...
	public final native Object createFont(String name, double size, boolean smooth) /*-{
		return this.createFont(name, size, smooth);
	}-*/;

	public final native Object createFont(String name, double size, boolean smooth, char[] charset) /*-{
	...
	public final native void image(Object img, int x, int y, int width, int height) /*-{
		this.image(img, x, y, width, height);
	}-*/;

	public final native void image(Object img, double x, double y, double width, double height) /*-{
		this.image(img, x, y, width, height);
	}-*/;
	...
	public final native void copy(int x, int y, int width, int height, int dx, int dy, int dwidth, int dheight) /*-{
		this.copy(x,y,width,height,dx,dy,dwidth,dheight);
	}-*/;

	public final native void copy(Object srcImg, int x, int y, int width, int height, int dx, int dy, int dwidth, int dheight) /*-{
	...
	public final native double blendColor(Object color1, Object color2, Object mode) /*-{
	...
	public final native Object color(int value1, int value2, int value3, int alpha) /*-{
	...
	public final native double map(double value, double istart, double istop, double ostart, double ostop) /*-{
	...
	public final native void applyMatrix(double n00, double n01, double n02,
		...
		this.applyMatrix(n00, n01, n02, n03, n04, n05, n06, n07, n08, n09, n10, n11, n12, n13, n14, n15);
	}-*/;
	...
	public final native void shape(Object sh, int x, int y, int width, int height) /*-{
		this.shape(sh, x, y, width, height);
	}-*/;

	public final native void shape(Object sh, double x, double y, double width, double height) /*-{
		this.shape(sh, x, y, width, height);
	}-*/;
	...
	public final native void createGraphics(int width, int height, Object renderer) /*-{
		return this.createGraphics(width, height, renderer);
	}-*/;

	public final native Object createGraphics(int width, int height, Object renderer, String filename) /*-{
	...
	public final native void ambientLight(int v1, int v2, int v3, int x, int y, int z) /*-{
		this.ambientLight(v1,v2,v3,x,y,z);
	}-*/;

	public final native void ambientLight(double v1, double v2, double v3, double x, double y, double z) /*-{
		this.ambientLight(v1,v2,v3,x,y,z);
	}-*/;

	public final native void directionalLight(int v1, int v2, int v3, int nx, int ny, int nz) /*-{
		this.directionalLight(v1,v2,v3,nx,ny,nz);
	}-*/;

	public final native void directionalLight(double v1, double v2, double v3, double nx, double ny, double nz) /*-{
		this.directionalLight(v1,v2,v3,nx,ny,nz);
	}-*/;

	public final native void lightFalloff(int constant, int linear, int quadratic) /*-{
		this.lightFalloff(constant,linear,quadratic);
	}-*/;

	public final native void lightFalloff(double constant, double linear, double quadratic) /*-{
		this.lightFalloff(constant,linear,quadratic);
	}-*/;
	...
	public final native void pointLight(int v1, int v2, int v3, int nx, int ny, int nz) /*-{
		this.pointLight(v1,v2,v3,nx,ny,nz);
	}-*/;

	public final native void pointLight(double v1, double v2, double v3, double nx, double ny, double nz) /*-{
		this.pointLight(v1,v2,v3,nx,ny,nz);
	}-*/;

	public final native void spotLight(int v1, int v2, int v3, int nx, int ny, int nz, double angle, double concentration) /*-{
		this.spotLight(v1,v2,v3,nx,ny,nz,angle,concentration);
	}-*/;

	public final native void spotLight(double v1, double v2, double v3, double nx, double ny, double nz, double angle, double concentration) /*-{
		this.spotLight(v1,v2,v3,nx,ny,nz,angle,concentration);
	}-*/;
	...
	public final native void camera(double eyeX, double eyeY, double eyeZ, double centerX, double centerY, double centerZ, double upX, double upY, double upZ) /*-{
	...
	public final native void frustum(double left, double right, double bottom, double top, double near, double far) /*-{
	...
	public final native void ortho(double left, double right, double bottom, double top, double near, double far) /*-{
	...
	public final native void perspective(double fov, double aspect, double zNear, double zFar) /*-{
